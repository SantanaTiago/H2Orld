...
public class InstatiateFaucetLeft : MonoBehaviour {
    float randomTime;
    float randomYValue;
    ...
    //private void StartLocalDrops()
    //{
    //    Drops = StartCoroutine(waterDrops());
    //}

    //private void StopLocalDrops()
    //{
    //    StopCoroutine(Drops);
    //}

    //IEnumerator waterDrops()
    //{
    //    while (true)
    //    {
